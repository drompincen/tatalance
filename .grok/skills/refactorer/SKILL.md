...
name: refactorer
description: >
  Safe, incremental code restructuring with test verification at each step. Use when the user runs /refactorer or asks for refactorer workflow help.
metadata:
  short-description: "drom-flow: refactorer"
  source: drom-flow
---
