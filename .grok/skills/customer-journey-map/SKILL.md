...
description: >
  Create a customer journey map across stages, touchpoints, actions, emotions, and metrics. Use when diagnosing a broken experience or aligning a team on the full customer flow.. Use when the user runs /customer-journey-map or asks for customer-journey-map workflow help.
metadata:
  short-description: "drom-flow: customer-journey-map"
  source: drom-flow
---
