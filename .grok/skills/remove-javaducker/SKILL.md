...
description: >
  Remove JavaDucker companion tool configuration from this project. Use when the user runs /remove-javaducker or asks for remove-javaducker workflow help.
metadata:
  short-description: "drom-flow: remove-javaducker"
  source: drom-flow
---
