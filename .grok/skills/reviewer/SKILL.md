...
name: reviewer
description: >
  Code review with severity ratings and actionable feedback. Use when the user runs /reviewer or asks for reviewer workflow help.
metadata:
  short-description: "drom-flow: reviewer"
  source: drom-flow
---
