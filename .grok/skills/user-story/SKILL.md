...
name: user-story
description: >
  Create user stories with Mike Cohn format and Gherkin acceptance criteria. Use when turning user needs into development-ready work with clear outcomes and testable conditions.. Use when the user runs /user-story or asks for user-story workflow help.
metadata:
  short-description: "drom-flow: user-story"
  source: drom-flow
---
