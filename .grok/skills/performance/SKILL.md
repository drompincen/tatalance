...
name: performance
description: >
  Optimize web performance for faster loading and better user experience. Use when asked to "speed up my site", "optimize performance", "reduce load time", "fix slow loading", "improve page speed", or "performance audit".. Use when the user runs /performance or asks for performance workflow help.
metadata:
  short-description: "drom-flow: performance"
  source: drom-flow
---
