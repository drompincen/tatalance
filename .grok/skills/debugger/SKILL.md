...
name: debugger
description: >
  Systematic bug investigation and root cause analysis. Use when the user runs /debugger or asks for debugger workflow help.
metadata:
  short-description: "drom-flow: debugger"
  source: drom-flow
---
