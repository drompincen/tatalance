...
description: >
  Break a large story or epic into smaller deliverable stories using proven split patterns. Use when backlog items are too big for estimation, sequencing, or independent release.. Use when the user runs /user-story-splitting or asks for user-story-splitting workflow help.
metadata:
  short-description: "drom-flow: user-story-splitting"
  source: drom-flow
---
