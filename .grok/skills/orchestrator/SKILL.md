...
name: orchestrator
description: >
  Design and run closed-loop pipelines that iterate until all checks pass. Use when the user runs /orchestrator or asks for orchestrator workflow help.
metadata:
  short-description: "drom-flow: orchestrator"
  source: drom-flow
---
