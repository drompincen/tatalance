...
description: >
  Choose a prioritization framework based on stage, team context, and stakeholder needs. Use when deciding between RICE, ICE, value/effort, or another scoring approach.. Use when the user runs /prioritization-advisor or asks for prioritization-advisor workflow help.
metadata:
  short-description: "drom-flow: prioritization-advisor"
  source: drom-flow
---
