...
name: implementer
description: >
  Write production-quality code following project conventions. Use when the user runs /implementer or asks for implementer workflow help.
metadata:
  short-description: "drom-flow: implementer"
  source: drom-flow
---
