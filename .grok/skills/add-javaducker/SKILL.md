...
name: add-javaducker
description: >
  Configure JavaDucker as an optional companion tool for semantic code search and indexing. Use when the user runs /add-javaducker or asks for add-javaducker workflow help.
metadata:
  short-description: "drom-flow: add-javaducker"
  source: drom-flow
---
