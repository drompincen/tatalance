...
name: accessibility
description: >
  Audit and improve web accessibility following WCAG 2.2 guidelines. Use when asked to "improve accessibility", "a11y audit", "WCAG compliance", "screen reader support", "keyboard navigation", or "make accessible".. Use when the user runs /accessibility or asks for accessibility workflow help.
metadata:
  short-description: "drom-flow: accessibility"
  source: drom-flow
---
