...
description: >
  Run a full discovery cycle from problem hypothesis to validated solution. Use when a team needs a structured path through framing, interviews, synthesis, and experiments.. Use when the user runs /discovery-process or asks for discovery-process workflow help.
metadata:
  short-description: "drom-flow: discovery-process"
  source: drom-flow
---
