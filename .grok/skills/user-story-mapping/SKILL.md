...
description: >
  Create a user story map that lays out activities, steps, tasks, and release slices. Use when planning a workflow, backlog, or MVP around the user journey.. Use when the user runs /user-story-mapping or asks for user-story-mapping workflow help.
metadata:
  short-description: "drom-flow: user-story-mapping"
  source: drom-flow
---
