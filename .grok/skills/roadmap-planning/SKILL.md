...
description: >
  Plan a strategic roadmap across prioritization, epic definition, stakeholder alignment, and sequencing. Use when turning strategy into a release plan that teams can execute.. Use when the user runs /roadmap-planning or asks for roadmap-planning workflow help.
metadata:
  short-description: "drom-flow: roadmap-planning"
  source: drom-flow
---
