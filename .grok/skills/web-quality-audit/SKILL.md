...
description: >
  Comprehensive web quality audit covering performance, accessibility, SEO, and best practices. Use when asked to "audit my site", "review web quality", "run lighthouse audit", "check page quality", or "optimize my website".. Use when the user runs /web-quality-audit or asks for web-quality-audit workflow help.
metadata:
  short-description: "drom-flow: web-quality-audit"
  source: drom-flow
---
