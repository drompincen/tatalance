...
description: >
  Build a structured PRD that connects problem, users, solution, and success criteria. Use when turning discovery notes into an engineering-ready document for a major initiative.. Use when the user runs /prd-development or asks for prd-development workflow help.
metadata:
  short-description: "drom-flow: prd-development"
  source: drom-flow
---
