...
name: api-expert
description: >
  Design and implement contract-first REST APIs in Java/Spring Boot with OpenAPI 3.1, security, rate limiting, and consistent resource shapes. Use when the user runs /api-expert or asks for api-expert workflow help.
metadata:
  short-description: "drom-flow: api-expert"
  source: drom-flow
---
