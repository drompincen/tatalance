...
description: >
  Uncover customer jobs, pains, and gains in a structured JTBD format. Use when clarifying unmet needs, repositioning a product, or improving discovery and messaging.. Use when the user runs /jobs-to-be-done or asks for jobs-to-be-done workflow help.
metadata:
  short-description: "drom-flow: jobs-to-be-done"
  source: drom-flow
---
