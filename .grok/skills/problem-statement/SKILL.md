...
description: >
  Write a user-centered problem statement with who is blocked, what they are trying to do, why it matters, and how it feels. Use when framing discovery, prioritization, or a PRD.. Use when the user runs /problem-statement or asks for problem-statement workflow help.
metadata:
  short-description: "drom-flow: problem-statement"
  source: drom-flow
---
