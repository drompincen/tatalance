...
description: >
  Optimize Core Web Vitals (LCP, INP, CLS) for better page experience and search ranking. Use when asked to "improve Core Web Vitals", "fix LCP", "reduce CLS", "optimize INP", "page experience optimization", or "fix layout shifts".. Use when the user runs /core-web-vitals or asks for core-web-vitals workflow help.
metadata:
  short-description: "drom-flow: core-web-vitals"
  source: drom-flow
---
