...
name: planner
description: >
  Decompose complex tasks into chapter-based plans saved to drom-plans/, with progress tracking and session resumption. Use when the user runs /planner or asks for planner workflow help.
metadata:
  short-description: "drom-flow: planner"
  source: drom-flow
---
