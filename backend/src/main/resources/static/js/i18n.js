    ...
    en: {
      ...
      client: {
        form: {
          ...
          phoneHint: 'E.164 format — start with +, then digits only (no spaces)',
          firstNameRequired: 'First name is required',
          lastNameRequired: 'Last name is required',
          phoneE164: 'Phone must be E.164 format: + followed by 10-15 digits',
          addBtn: 'Add Client',
      ...
      messages: {
        ...
        saveFailed: '✗ Save failed — check server logs',
        ...
        deleteFailed: 'Delete failed — check server logs',
        someDeletesFailed: 'Some deletes failed:\n{errors}',
        cancelRide: 'Cancel this ride?',
        cannotCancelRide: 'Cannot cancel this ride',
        cancelFailed: 'Cancel failed — check server logs',
        markPayoutPaid: 'Mark this driver payout as paid?',
        markPayoutFailed: 'Failed to mark payout',
        completeFailed: 'Complete failed — check server logs',
        completeJobConfirm: 'Mark job complete now? (uses live elapsed since start × $20)',
        startJobFailed: 'Could not start job (check server status/logs)',
        invoiceFailed: 'Invoice failed: {message}',
        ...
        linkGoogleFailed: 'Could not start Google linking. Try again.',
      },
      help: {
        welcome: {
    ...
    es: {
      ...
      client: {
        form: {
          ...
          phoneHint: 'Formato E.164 — empiece con +, solo dígitos (sin espacios)',
          firstNameRequired: 'El nombre es obligatorio',
          lastNameRequired: 'El apellido es obligatorio',
          phoneE164: 'El teléfono debe ser E.164: + seguido de 10-15 dígitos',
      ...
      messages: {
        ...
        saveFailed: '✗ Error al guardar — revise los logs del servidor',
        ...
        deleteFailed: 'Error al eliminar — revise los logs del servidor',
        ...
        cancelFailed: 'Error al cancelar — revise los logs del servidor',
        markPayoutPaid: '¿Marcar este pago al chofer como pagado?',
        markPayoutFailed: 'Error al marcar el pago',
        completeFailed: 'Error al completar — revise los logs del servidor',
        completeJobConfirm: '¿Marcar trabajo como completado ahora? (usa tiempo transcurrido × $20)',
        startJobFailed: 'No se pudo iniciar el trabajo (revise el servidor/logs)',
        invoiceFailed: 'Error en factura: {message}',
        failed: 'Error: {message}',
        failedCreateTable: 'Error al crear la tabla',
        ...
        failedLoadProfiles: 'Error al cargar perfiles.',
        ...
        linkGoogleFailed: 'No se pudo iniciar la vinculación con Google. Intente de nuevo.',
      },
      help: {
        welcome: {
